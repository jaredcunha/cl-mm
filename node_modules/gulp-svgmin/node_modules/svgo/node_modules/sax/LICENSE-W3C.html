...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="generator" content="HTML Tidy for Mac OS X (vers 31 October 2006 - Apple Inc. build 13), see www.w3.org" /><title>W3C Software Notice and License</title><link rel="stylesheet" href="/2008/site/css/minimum" type="text/css" media="handheld, all" /><style type="text/css" media="print, screen and (min-width: 481px)" xml:space="preserve">
     @import url("/2008/site/css/advanced");
         ...
         <div id="w3c_mast">
            <h1 class="logo">
               <a tabindex="2" accesskey="1" href="/"><img src="http://www.jaredcunha.com/mm_images/2008/site/images/logo-w3c-mobile-lg" width="90" height="53" alt="W3C" /></a>
            ...
            <div id="w3c_nav">
               ...
               <form action="/Help/search" method="get" enctype="application/x-www-form-urlencoded"><div class="w3c_sec_nav"><!-- --></div><ul class="main_nav"><li class="first-item">
                        ...
                        <div id="search-form">
                           ...
                           <button id="search-submit" name="search-submit" type="submit"><img class="submit" src="http://www.jaredcunha.com/mm_images/2008/site/images/search-button" alt="Search" width="21" height="17" /></button>
                        </div>
                     </li></ul></form>
            </div>
         ...
         <div id="w3c_main">
            <div id="w3c_logo_shadow" class="w3c_leftCol">
               <img height="32" alt="" src="http://www.jaredcunha.com/mm_images/2008/site/images/logo-shadow" />
            </div>
            
            <div class="w3c_leftCol"><h2 class="offscreen">Site Navigation</h2>
    <h3 class="category"><span class="ribbon"><a href="/Consortium/Legal/ipr-notice.html" title="Up to Policies and Legal Information">Policies and Legal Information <img src="http://www.jaredcunha.com/mm_images/2008/site/images/header-link" alt="Header link" width="13" height="13" class="header-link" /></a></span></h3>
       <ul class="theme">
...
Definition</a>.</p>
            ...
            <div class="w3c_footer-nav">
               ...
               <ul class="footer_follow_nav"><li>
                     <a href="http://twitter.com/W3C" title="Follow W3C on Twitter">
                        <img src="http://www.jaredcunha.com/mm_images/2008/site/images/twitter-bird" alt="Twitter" width="78" height="83" class="social-icon" />
                     </a>
                     <a href="http://identi.ca/w3c" title="See W3C on Identica">
                        <img src="http://www.jaredcunha.com/mm_images/2008/site/images/identica-logo" alt="Identica" width="91" height="83" class="social-icon" />
                     </a>
                  </li></ul>
            </div>
         ...
         <script type="text/javascript" src="http://www.jaredcunha.com/mm_images/2008/site/js/main" xml:space="preserve"><!-- --></script>
      </div></body></html>
